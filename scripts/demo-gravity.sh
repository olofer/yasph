...
python3 ../scripts/yasph-init-ball.py --num-per-gas $1 --particle-file gdemo-parts.yasph --parameter-file gdemo-params.yasph --barrier-radius 1.00 --density 0.1786 5.851 --pressure 1e2 1e2
...
./yasph gdemo-parts.yasph gdemo-params-explicit.yasph steps=5e4 dt=4.0e-6 threads=4 verbosity=1 gravity=0.0,-9.82 > gravity-log.yasph 
